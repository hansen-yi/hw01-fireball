...
class ShaderProgram {
  ...
  unifOtherColor: WebGLUniformLocation;
  ...
  constructor(shaders: Array<Shader>) {
    ...
    this.unifOtherColor = gl.getUniformLocation(this.prog, "u_OtherColor");
    this.unifTime       = gl.getUniformLocation(this.prog, "u_Time");
    this.unifOctaves    = gl.getUniformLocation(this.prog, "u_Ocatves");
  ...
  setOtherColor(color: vec4) {
    this.use();
    if (this.unifOtherColor !== -1) {
      gl.uniform4fv(this.unifOtherColor, color);
    }
  }
